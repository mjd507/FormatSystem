...
<script
	src="/format/assets/bootstrap-table/src/extensions/filter-control/bootstrap-table-filter-control.js"></script>
<script
...
<body
	...
	<div class="container" style="min-height: 800px; min-width: 1000px;">
		...
		<table id="table" data-toggle="table"
			data-url="/format/department/getListForAdmin?userName=<%=session.getAttribute("userName")%>&userId=<%=session.getAttribute("userId")%>"
			data-filter-control="false" data-filter-show-clear="true"
			data-pagination="true" data-show-export="true" data-search="true"
			...
			<thead>
				<tr>
					...
					<th data-field="oName" data-editable="false" data-sortable="true"
						data-filter-control="select">所属组织</th>
		...
		<!-- fade遮罩层 -->
		<div class="modal fade" id="modal-container-217103" role="dialog"
						...
						<div class="row clearfix">
							<div class="col-md-12 column">
								<form class="form-horizontal" role="form"
									action="/format/department/addByoId" method="POST"
									onsubmit="return checkAdmin()" enctype="multipart/form-data">
									<input type="hidden" value="${sessionScope.oId}" name="oId" id="oId"/>
									<div class="form-group">
										<label for="addName" class="col-md-2 control-label">名称</label>
										<div class="col-md-10">
